    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light border-top-0">
                <button type="button" id="confirmSubmitBtnCancelAdd" class="btn btn-outline-secondary px-4" data-bs-dismiss="modal">Cancel</button>
                <button type="button" id="confirmSubmitBtnAdd" class="btn btn-primary px-4 shadow-sm">Yes, Save Records</button>
            </div>
        </div>
    </div>
</div>

        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="card-header bg-success text-white p-4 border-0 position-relative" style="background: linear-gradient(135deg, #157347 0%, #0f5132 100%);">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="fw-bold mb-1 tracking-tight fs-3">Edit API Gateway</h4>
                        <p class="text-white-50 small mb-0 opacity-75 fs-6">Update configuration settings for {{ $apiSetting->service_provider }}.</p>
                    </div>
                </div>
            </div>

            <!-- Changed action to update route, added PUT method directive -->
            <form class="editApiSettingForm needs-validation" action="{{ route('api_settings.update', $apiSetting->id) }}" method="POST" data-confirm-update novalidate>
                @csrf
                @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3 @error('service_provider') is-invalid @enderror" id="service_provider" name="service_provider" value="{{ old('service_provider', $apiSetting->service_provider) }}" placeholder="e.g., Twilio, Telegram" required>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <select class="form-select form-select-lg fs-5 py-3 @error('api_type') is-invalid @enderror" id="api_type" name="api_type" required>
                                        <option value="" disabled>Select Gateway Type</option>
                                        <option value="telegram" {{ old('api_type', $apiSetting->api_type) == 'telegram' ? 'selected' : '' }}>Telegram</option>
                                        <option value="viber" {{ old('api_type', $apiSetting->api_type) == 'viber' ? 'selected' : '' }}>Viber</option>
                                        <option value="sms" {{ old('api_type', $apiSetting->api_type) == 'sms' ? 'selected' : '' }}>SMS</option>
                                        <option value="email" {{ old('api_type', $apiSetting->api_type) == 'email' ? 'selected' : '' }}>Email / SMTP</option>
                                    </select>
                                    <div class="valid-feedback fs-6 mt-2">Looks good!</div>
                                    @error('api_type')
                                        <div class="invalid-feedback fs-6 mt-2 d-block">{{ $message }}</div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3 @error('unique_code') is-invalid @enderror" id="unique_code" name="unique_code" value="{{ old('unique_code', $apiSetting->unique_code) }}" placeholder="e.g., telegram_primary" required>
                                    <div class="valid-feedback fs-6 mt-2">Looks good!</div>
                                    @error('unique_code')
                                        <div class="invalid-feedback fs-6 mt-2 d-block">{{ $message }}</div>
                                    @else
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <select class="form-select form-select-lg fs-5 py-3 @error('environment') is-invalid @enderror" id="environment" name="environment" required>
                                        <option value="sandbox" {{ old('environment', $apiSetting->environment) == 'sandbox' ? 'selected' : '' }}>Sandbox (Test Mode)</option>
                                        <option value="production" {{ old('environment', $apiSetting->environment) == 'production' ? 'selected' : '' }}>Production (Live)</option>
                                    </select>
                                    <div class="valid-feedback fs-6 mt-2">Looks good!</div>
                                    @error('environment')
                                        <div class="invalid-feedback fs-6 mt-2 d-block">{{ $message }}</div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <input type="url" class="form-control form-control-lg fs-5 py-3" id="base_url" name="base_url" value="{{ old('base_url', $apiSetting->base_url) }}" placeholder="https://api.telegram.org">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <!-- Because it's cast to 'encrypted' in the model, Laravel auto-decrypts it for display here -->
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="api_key" name="api_key" value="{{ old('api_key', $apiSetting->api_key) }}" placeholder="Enter secure key">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="auth_token" name="auth_token" value="{{ old('auth_token', $apiSetting->auth_token) }}" placeholder="Enter authentication secret">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <!-- Automatically encodes the array cast back to a formatted JSON string for editing -->
                                    <textarea class="form-control form-control-lg fs-5 p-3" id="config_payload" name="config_payload" rows="4" placeholder='{"Sender_ID": "MyPawnshop", "Header": "Auth"}' style="font-family: monospace;">{{ old('config_payload', $apiSetting->config_payload ? json_encode($apiSetting->config_payload, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : '') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <input type="number" class="form-control form-control-lg fs-5 py-3" id="priority" name="priority" value="{{ old('priority', $apiSetting->priority) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 d-flex gap-5 mt-lg-5">
                                <div class="form-check form-switch form-check-lg">
                                    <input class="form-check-input cs-pointer" type="checkbox" role="switch" id="is_active" name="is_active" value="1" {{ old('is_active', $apiSetting->is_active) ? 'checked' : '' }} style="transform: scale(1.5); margin-right: 15px;">
                                    <label class="form-check-label fw-bold text-dark fs-5 cs-pointer pt-1" for="is_active">Enable Gateway Status</label>
                                </div>

                                <div class="form-check form-switch form-check-lg">
                                    <input class="form-check-input cs-pointer" type="checkbox" role="switch" id="is_fallback" name="is_fallback" value="1" {{ old('is_fallback', $apiSetting->is_fallback) ? 'checked' : '' }} style="transform: scale(1.5); margin-right: 15px;">
                ...
                <div class="card-footer bg-light border-top border-light-subtle p-4 d-flex flex-column flex-sm-row justify-content-sm-end align-items-stretch align-items-sm-center gap-3">
                    <a href="{{ route('api_settings.show', $apiSetting->id) }}" class="btn btn-outline-secondary btn-lg px-4 py-3 fs-6 rounded-3 fw-bold text-nowrap text-center">
                        Cancel Update
                    </a>
                    <button type="submit" class="btn btn-success btn-lg px-4 shadow-sm rounded-3 fw-bold border-0 py-3 fs-6 text-nowrap d-flex align-items-center justify-content-center">
                        <i class="bi bi-arrow-repeat me-2 fs-5"></i>Update Gateway
                    </button>
                </div>
            </form>
        </div>

...
<div class="row">
    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden" style="border: 1px solid #e2e8f0 !important;">
            ...
            <!-- Integrated Header: Clean, Eye-Catching Secondary Slate -->
                ...
                <div class="row align-items-center">
                    <div class="col-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="bg-dark rounded-3 d-flex align-items-center justify-content-center shadow-sm me-3" style="width: 54px; height: 54px; background-color: #1e293b !important;">
                                <i class="bi bi-people-fill fs-3 text-white"></i>
                            </div>
                            <div>
                                <span class="text-white-50 fw-semibold uppercase tracking-wider small d-block mb-0.5" style="font-size: 0.85rem; letter-spacing: 0.5px;">SYSTEM MANAGEMENT</span>
                                <h3 class="fw-bold mb-0 text-white fs-3">Customer Registry</h3>
                            </div>
                        </div>
                        <!-- High Visibility Print Action Button -->
                        <div>
                            <a href="{{ route('prints.print_customer_info') }}" target="_blank" class="btn btn-light btn-lg shadow-sm px-4 py-2 fw-bold fs-6 text-dark rounded-3">
                                <i class="bi bi-printer-fill me-2"></i> Print Customer List
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body p-0 bg-white">
                @if($customers->count() > 0)
                    <!-- Perfectly Center-Aligned Bootstrap Table -->
                ...
                @else
                    ...
                    <div class="text-center py-5 my-3">
                        ...
                        <h3 class="text-dark fw-bold">No customers registered yet</h3>
                        <p class="text-muted fs-5">Your registry database is currently empty.</p>
                    </div>
                @endif
            </div>
...
<style>
    /* Readable sizing adjustments for older owners */

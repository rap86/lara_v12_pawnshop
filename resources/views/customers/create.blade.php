...
<div class="card border-0 shadow-lg">
    ...
    <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" id="cellphone_number" name="cellphone_number" value="{{ old('cellphone_number') }}">
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0" id="address" name="address" placeholder="123 Street, City, State" value="{{ old('address') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer bg-light border-top-0 px-4 py-3 text-end">
            <a href="{{ route('customers.index') }}" class="btn btn-outline-secondary px-4 me-2" id="btnCancelProcedure">Cancel</a>
            <div id="btnModalConfirmationForNewRecord" class="btn btn-success px-4 shadow-sm">Save Customer</div>
        </div>
    </form>
</div>
@endsection

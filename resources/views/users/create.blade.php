...
<div class="row">
    <div class="col-12">
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <!-- Clean Create Action Form Workflow -->
            <form class="createUserForm needs-validation" action="{{ route('users.store') }}" method="POST" data-confirm-add novalidate>
                ...
                <div class="card-body p-4 p-lg-4 bg-white">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="name" name="name" placeholder="John Doe" required>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="username" name="username" placeholder="johndoe" required>
                                    <div class="valid-feedback fs-6 mt-2">Looks good!</div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="email" class="form-control form-control-lg fs-5 py-3" id="email" name="email" placeholder="johndoe@domain.com" required>
                                    <div class="valid-feedback fs-6 mt-2">Looks good!</div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <label for="floating_id" class="form-label fw-bold text-dark fs-5 mb-2">Floating  Staff</label>
                                <div class="p-3 bg-light border rounded-3 shadow-sm d-flex align-items-center w-100 style-lg-input">
                                    <div class="form-check form-switch form-switch-lg mb-0 fs-6 w-100 d-flex align-items-center">
                                        <input class="form-check-input cs-pointer" type="checkbox" id="is_floating" name="is_floating" value="1">
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="phone_number" name="phone_number" placeholder="e.g., +63917XXXXXXX">
                                </div>
                            </div>
                            <!-- Telegram Chat ID -->
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="chat_id_telegram" name="chat_id_telegram" placeholder="e.g., 582910482">
                                </div>
                            </div>
                            <!-- Viber Chat ID -->
                            <div class="col-lg-4">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg fs-5 py-3" id="chat_id_viber" name="chat_id_viber" placeholder="e.g., vbr-usr-77a19...">
                                </div>
                            </div>
                        </div>

                        <!-- Premium Option Cards for individual 2FA Switches -->
                        <div class="row g-3">
                            <!-- Gmail Switch -->
                            <div class="col-sm-6 col-xl-2.4">
                                <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center h-100">
                                    <div class="form-check form-switch form-switch-lg mb-0 fs-4 w-100 d-flex align-items-center">
                                        <input class="form-check-input cs-pointer" type="checkbox" id="two_factor_gmail" name="two_factor_gmail" value="1">
                            ...
                            <div class="col-sm-6 col-xl-2.4">
                                <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center h-100">
                                    <div class="form-check form-switch form-switch-lg mb-0 fs-4 w-100 d-flex align-items-center">
                                        <input class="form-check-input cs-pointer" type="checkbox" id="two_factor_yahoo" name="two_factor_yahoo" value="1">
                            ...
                            <div class="col-sm-6 col-xl-2.4">
                                <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center h-100">
                                    <div class="form-check form-switch form-switch-lg mb-0 fs-4 w-100 d-flex align-items-center">
                                        <input class="form-check-input cs-pointer" type="checkbox" id="two_factor_sms" name="two_factor_sms" value="1">
                            ...
                            <div class="col-sm-6 col-xl-2.4">
                                <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center h-100">
                                    <div class="form-check form-switch form-switch-lg mb-0 fs-4 w-100 d-flex align-items-center">
                                        <input class="form-check-input cs-pointer" type="checkbox" id="two_factor_telegram" name="two_factor_telegram" value="1">
                            ...
                            <div class="col-sm-6 col-xl-2.4">
                                <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center h-100">
                                    <div class="form-check form-switch form-switch-lg mb-0 fs-4 w-100 d-flex align-items-center">
                                        <input class="form-check-input cs-pointer" type="checkbox" id="two_factor_viber" name="two_factor_viber" value="1">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="password" class="form-control form-control-lg fs-5 py-3" id="password" name="password" placeholder="••••••••" minlength="8" required>
                                    <div class="invalid-feedback fs-6 mt-2">Password must be at least 8 characters long and is required.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                                    ...
                                    <input type="password" class="form-control form-control-lg fs-5 py-3" id="password_confirmation" name="password_confirmation" placeholder="••••••••" required>
                                    <div class="invalid-feedback fs-6 mt-2">Please confirm your password entry.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer bg-light border-top border-light-subtle p-4 d-flex flex-column flex-sm-row justify-content-sm-end align-items-stretch align-items-sm-center gap-3">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg px-4 shadow-sm rounded-3 fw-semibold border-0 py-3 fs-5 text-nowrap d-flex align-items-center justify-content-center">

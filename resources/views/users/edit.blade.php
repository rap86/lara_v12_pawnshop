    ...
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
        ...
        <form class="editUserForm needs-validation" action="" method="POST" data-confirm-update novalidate>
            ...
            <div class="card-body p-4 p-lg-5 bg-white">
                ...
                <div class="mb-5">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h4 class="fw-bold text-dark mb-0 fs-5">Personal Profile</h4>
                    </div>

                    <div class="row g-4">
                        <!-- Full Name -->
                        <div class="col-lg-4">
                            <label for="edit_name" class="form-label fw-bold text-dark fs-6 mb-2">Full Name</label>
                        ...
                        <!-- Username -->
                        <div class="col-lg-4">
                            <label for="edit_username" class="form-label fw-bold text-dark fs-6 mb-2">Username</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                        ...
                        <!-- Email Address -->
                        <div class="col-lg-4">
                            <label for="edit_email" class="form-label fw-bold text-dark fs-6 mb-2">Email Address</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                ...
                <div class="mb-5">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h4 class="fw-bold text-dark mb-0 fs-5">Access & Assignment</h4>
                    </div>

                    <div class="row g-4">
                        <!-- System Role -->
                        <div class="col-lg-4">
                            <label for="edit_role" class="form-label fw-bold text-dark fs-6 mb-2">System Role</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                        ...
                        <!-- Status -->
                        <div class="col-lg-4">
                            <label for="edit_status" class="form-label fw-bold text-dark fs-6 mb-2">Account Status</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                        ...
                        <!-- Branch -->
                        <div class="col-lg-4">
                            <label for="edit_branch_id" class="form-label fw-bold text-dark fs-6 mb-2">Assigned Branch</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                ...
                <div class="mb-5 bg-light rounded-4 p-4 border border-light-subtle">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h4 class="fw-bold text-dark mb-0 fs-5">Two-Factor Authentication (2FA)</h4>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-12">
                            <label for="cellphone_number" class="form-label fw-bold text-dark fs-6 mb-2">Direct Contact Number</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3 has-validation">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 col-xl-3">
                            <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center">
                                <div class="form-check form-switch form-switch-lg mb-0 fs-4">
                                    <input class="form-check-input cs-pointer" type="checkbox" id="2fa_gmail" name="two_factor[]" value="gmail">
                                    <label class="form-check-label text-dark fw-bold ms-2 fs-5" for="2fa_gmail"><i class="bi bi-google text-danger me-1"></i> Gmail</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center">
                                <div class="form-check form-switch form-switch-lg mb-0 fs-4">
                                    ...
                                    <label class="form-check-label text-dark fw-bold ms-2 fs-5" for="2fa_sms"><i class="bi bi-chat-text text-primary me-1"></i> SMS Gateway</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center">
                                <div class="form-check form-switch form-switch-lg mb-0 fs-4">
                                    ...
                                    <label class="form-check-label text-dark fw-bold ms-2 fs-5" for="2fa_telegram"><i class="bi bi-telegram text-info me-1"></i> Telegram</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                            <div class="p-3 bg-white border rounded-3 shadow-sm d-flex align-items-center">
                                <div class="form-check form-switch form-switch-lg mb-0 fs-4">
                                    ...
                                    <label class="form-check-label text-dark fw-bold ms-2 fs-5" for="2fa_viber"><i class="bi bi-violet text-purple me-1"></i> Viber</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-2">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <h4 class="fw-bold text-dark mb-0 fs-5">Security Override</h4>
                        </div>
                    ...
                    <div class="row g-4">
                        <!-- New Password -->
                        <div class="col-lg-6">
                            <label for="edit_password" class="form-label fw-bold text-dark fs-6 mb-2">New Password</label>
                        ...
                        <div class="col-lg-6">
                            <label for="edit_password_confirmation" class="form-label fw-bold text-dark fs-6 mb-2">Confirm New Password</label>
                            <div class="input-group input-group-lg shadow-sm rounded-3">
            ...
            <div class="card-footer bg-light border-top border-light-subtle p-4 d-flex flex-column flex-sm-row justify-content-sm-end align-items-stretch align-items-sm-center gap-3">
                <a href="{{ route('users.index') }}" class="btn btn-outline-secondary btn-lg px-4 py-3 fs-6 rounded-3 fw-bold text-nowrap text-center">
                    Discard Changes
                </a>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form) {
        form.addEventListener('submit', function (event) {
            // Check matching passwords before submission if entered
